function [beta,out,err,delta,net] = distributed_classification(X,Y,K,lambda,n_nodi,W,n_iter)
%DISTRIBUTED_REGRESSION definisce un algoritmo di classificazione distribuito
