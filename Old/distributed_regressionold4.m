function [beta,out,err,delta,beta_distr,out_distr,err_distr,net,prova] = distributed_regressionold4(X,Y,K,lambda,n_nodi,W,n_iter)
...
%ogni nodo
        ...
        for ii = 1:n_iter
            ...
            new = neigh(labindex)*sol;
            
            labSend(sol, neigh_idx);
