...
figshift;
hold on
plot(error(:,1,1),(mean(error(:,2,:),3)),'k','LineWidth',line_width);
hold on
errorbar(error(:,1,1)+1,(mean(error(:,3,:),3)),devst_err(:,3),'b','LineWidth',line_width);
errorbar(error(:,1,1),(mean(error(:,4,:),3)),devst_err(:,4),'r','LineWidth',line_width);
