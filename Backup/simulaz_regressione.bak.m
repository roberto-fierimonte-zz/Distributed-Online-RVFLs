...
if scelta==0
    ...
    switch scelta
        case 1
            ...
            simulaz_regressione_batch(X,Y,k,n,K,lambda,n_iter,vett_nodi);
        case 2
            %Questi parametri sono usati all'interno della simulazione
            %online
            K=input('\nInserisci la dimensione dell espansione funzionale (K): ');
            ...
            simulaz_regressione_online(X,Y,k,n,K,lambda,n_iter,n_nodi,on);
        case 3
            ...
            simulaz_regressione_param(X,Y,lambdavec,Kmax,n_iter,n_fold);
        otherwise
