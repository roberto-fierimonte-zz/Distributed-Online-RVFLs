function [soluzione] = consensus(beta, W, n_iter)
%CONSENSUS definisce un semplice algoritmo di consenso per reti di
%sensori, in cui ogni sensore stima un proprio parametro sulla base di una
%porzione del training set. Per ora funziona 
%
%Input: beta: matrice (sxn) dei parametri inziali del grafo (s parametri per
%           n nodi)
